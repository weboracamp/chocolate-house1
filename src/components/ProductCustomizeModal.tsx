...
import { X, Plus, Minus, Check, Sparkles, CupSoda, CheckCircle2 } from 'lucide-react';
...
export const FLAVOR_OPTIONS = [
  { id: 'flavor_vanilla', name_en: 'Vanilla', name_ar: 'فانيليا', price: 15, icon: '✨' },
  { id: 'flavor_caramel', name_en: 'Caramel', name_ar: 'كراميل', price: 15, icon: '🍯' },
];

// 3. TOPPING ADD-ONS (Apply to ALL products, multi-select)
export const TOPPING_OPTIONS = [
  { id: 'topping_condensed_milk', name_en: 'Condensed Milk', name_ar: 'حليب مكثف', price: 20, icon: '🥛' },
  { id: 'topping_white_chocolate', name_en: 'White Chocolate', name_ar: 'شوكلت وايت', price: 20, icon: '🍫' },
  { id: 'topping_dark_chocolate', name_en: 'Dark Chocolate', name_ar: 'شوكلت دارك', price: 20, icon: '🍫' },
];
...
export const ProductCustomizeModal: React.FC<ProductCustomizeModalProps> = ({
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-lg bg-[#FFFBF5] rounded-3xl shadow-2xl overflow-hidden border border-[#D4AF37]/30 my-6 flex flex-col max-h-[90vh]">
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm select-none">{flavor.icon}</span>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm select-none">{topping.icon}</span>
