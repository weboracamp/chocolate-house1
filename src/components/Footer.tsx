          ...
          <div className="space-y-4">
            ...
            {isSubscribed ? (
              ...
              <form onSubmit={handleNewsletterSubmit} className="space-y-2">
                ...
                <button
                  type="submit"
                  className="w-full flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl text-xs font-bold text-[#1A0A06] transition-all transform hover:scale-[1.01] active:scale-[0.99] shadow-md hover:shadow-lg cursor-pointer"
                  style={{
