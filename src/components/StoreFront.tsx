...
import heroIcedCoffeeCup from '../assets/images/iced_latte_cup_1787591728364.jpg';
import {
  Search,
  ArrowRight,
  ShoppingBag,
      ...
      <main className="flex-1 w-full flex flex-col">
        ...
        >
          ...
          <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-10 lg:gap-14 relative z-10">
            ...
            {/* Right Hero Image (Iced Coffee Cup prominent element without bulky card) */}
            <div className="w-full max-w-xs sm:max-w-sm lg:max-w-md flex items-center justify-center shrink-0 relative">
              {/* Backlight Ambient Glow Ring */}
              <div className="absolute inset-0 m-auto w-72 h-72 sm:w-80 sm:h-80 bg-gradient-to-tr from-[#D4AF37]/25 to-[#F7E7A9]/10 rounded-full blur-2xl pointer-events-none" />

              <div className="relative group transition-transform duration-500 hover:scale-105">
                <img
                  src={heroIcedCoffeeCup}
                  alt="Chocolate House Signature Iced Latte"
                  className="w-full max-h-[420px] sm:max-h-[480px] object-contain rounded-2xl drop-shadow-[0_20px_35px_rgba(0,0,0,0.65)] select-none pointer-events-none"
                  loading="eager"
