...
ALTER TABLE public.products ADD COLUMN IF NOT EXISTS has_multiple_sizes BOOLEAN DEFAULT FALSE;
...
ALTER TABLE public.products ADD COLUMN IF NOT EXISTS size_label_small TEXT;
ALTER TABLE public.products ADD COLUMN IF NOT EXISTS size_label_large TEXT;
